...
{/*export const title = "Session Report: March to Ealtun 1"
export const description = "A session report for part one of a Paladins of Awoudan mini-campaign."
export const published = "Mar 1 2025"
export const image = "./tower-of-the-mad-mage.webp"
export const imageAlt = "A distorted, halftone image of a tower in the woods with ruined ramparts around it."
export const caption = "Map is Old Ruin In the Woods made by Hornston3 with Canvas of Kings"
export const tags = [RPG, fantasy, grimdark, paladins - of - awoudan, session - report]*/}
...
Aurora ascended the tower and found a grisly scene. The Hallow Knight had destroyed a four corner bedpost and used it for an improvised crucifixion of the Mad Mage. He was weak, but still alive. Aurora's clever frost spellwork saved the mage's life, while Evrild studied the bodies of the dead, and Guedwyn patrolled the surrounding area for a fell fire, a source of divine energy that helps Paladins heal faster.
