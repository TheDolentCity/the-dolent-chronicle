...
import { BookMarked, BookOpenText, CircleCheck, CircleHelp, Info, OctagonAlert } from "lucide-react";

export const AsideVariants = ["example", "info", "alert", "question", "tip"] as const;
...
export function Aside(props: AsideProps) {
	...
	const asideCss = new CssBuilder()
		.addClass("not-prose dark:saturate-50 my-4 lg:my-8 p-4 border-l-4 leading-none")
		.addClass("border-blue-800 dark:border-blue-400 text-zinc-700 dark:text-zinc-300 bg-blue-100/50 dark:bg-blue-950/50", type == "example")
		.addClass("border-blue-800 dark:border-blue-400 text-zinc-700 dark:text-zinc-300 bg-blue-100/50 dark:bg-blue-950/50", type == "info")
		.addClass("border-negative-800 dark:border-negative-400 text-zinc-700 dark:text-zinc-300 bg-negative-100/50 dark:bg-negative-950/50", type == "alert")
		.addClass("border-warning-800 dark:border-warning-400 text-zinc-700 dark:text-zinc-300 bg-warning-100/50 dark:bg-warning-950/50", type == "question")
		.addClass("border-accent-800 dark:border-accent-400 text-zinc-700 dark:text-zinc-300 bg-accent-100/50 dark:bg-accent-950/50", type == "tip")
		.build();
